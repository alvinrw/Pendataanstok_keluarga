                    ...
                    <table>
                        ...
                        <tbody id="table-body">
                            @forelse ($data as $index => $item)
                                <tr data-id="{{ $item->id }}" data-tanggal="{{ $item->tanggal }}"
                                    ...
                                    data-berat-total="{{ $item->berat_total }}" data-harga-total="{{ $item->harga_total }}"
                                    ...
                                    <td>
                                        <div class="action-btn-group">
                                            <button class="action-btn struk-btn" onclick="generateStruk(this)">📄
                                                Struk</button>
                                            @if (!empty($item->id))
    ...
    <script>
        ...
        function generateStruk(buttonEl) {
            ...
            <style>
                ...
                .ss-receipt-box .header {
                    text-align: center;
                    margin-bottom: 10px;
                }
                .ss-receipt-box .header h3 {
                    margin: 0;
                    font-weight: bold;
                }
                .ss-receipt-box hr {
                ...
                .ss-receipt-box .item-row {
                    display: flex;
                    justify-content: space-between;
                }
                .ss-receipt-box .footer {
                    text-align: center;
                    margin-top: 15px;
                    font-size: 13px;
                }
            ...
            <div class="ss-receipt-box">
                ...
                ${hasDiskon ? `<div class="item-row"><span>- Diskon</span> <span>- ${formatCurrency(diskonAmount)}</span></div>` : ''}
                <hr>
                <div class="item-row" style="font-size:1.1em"><strong><span>TOTAL</span></strong> <strong><span>${formatCurrency(hargaTotalFinal)}</span></strong></div>
                <hr>
